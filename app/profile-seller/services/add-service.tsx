          ...
          <form onSubmit={form.handleSubmit(onSubmit)}>
            <Grid columns="2" style={{ gap: "30px" }}>
              <div className="space-y-4">
                ...
                <div>
                  <FormLabel className="mb-3">Add Details</FormLabel>
                  <Input
                    value={detail}
                ...
                <div>
                  <FormLabel className="mb-3">Add Tools</FormLabel>
                  <Input
                    value={tool}
                    ...
                    onKeyDown={(e) => {
                      if (e.key === "Enter") {
                        e.preventDefault();
                        if (!tool.trim()) {
                          toast.error("Please enter a tool");
                          return;
                        }
                ...
                <div>
                  <FormLabel className="mb-3">Add Features</FormLabel>
                  <Input
                    value={feature}
            ...
            <DialogFooter className="mt-6">
              ...
              >
                {form.formState.isSubmitting ? <BeatLoader /> : "Save Service"}
              </Button>
            </DialogFooter>
          </form>
        </Form>
